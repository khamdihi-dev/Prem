...
/  ___>/     \/  _  \|  _  \  || [red]create by[/]
|___  ||  |--||  _  <|  |  |  || [red]khamdihi dev[/]
<_____/\_____/\_____/|_____/  || [red]simpel bruteforce v10.0[/]
''')
 ...
 >> User ID          : {self.ds_user} \n''',None,'[white]> [green]DETAIL USER[/] <')
       ...
       self.MyRich('\n \
[red]01. [white]Crack Dari Followers   \n \
[red]02. [white]Crack Dari Following   \n \
[red]03. [white]Check Akun Checkpoint  \n \
[red]04. [white]Check Hasil Crack      \n \
[red]05. [white]Save Hasil Ke SDcard   \n \
[red]06. [white]Crack Dari Komentar \n \
[red]07. [white]Crack Unlimited Followers \n \
[red]08. [white]Setting Thema/Warna Panel \n \
[red]09. [white]Laporkan Bug/Upgrade Key \n \
[red]10. [white]Ganti Akun Tumbalb\n \
[red]11. [white]Cari Akun Verif Email \n \
[red]12. [white]Requests Perbaikan\n ''',True)
       self.chs(self.aset)
   ...
   def chs(self, assets):
       while True:
         ...
         elif x in ['09','9']:exit(os.system('xdg-open https://wa.me/+6283853140469?text='))
         elif x in ['10']:os.system('rm -rf data/IG-login.txt');self.insta()
         elif x in ['12']:
              exit(os.system('xdg-open https://wa.me/+6283853140469?text=Mas+Mau+Requests+Perbaikan+Script+Ibrut'))
...
try:
    v = requests.get('https://raw.githubusercontent.com/khamdihi-dev/Prem/main/version.json').json()['SCBD']['version']
    if(versi == str(v)):print(f'\n   anda berada di versi terbaru : {v}');time.sleep(2)
    else:
        print(f'\n   anda menggunakan versi lama, versi sekarang : {v}')
        u = input('   update y/t : ')
        if u.lower() == 'y': os.system('git pull')
except:pass

if __name__ == '__main__': MainDev().Run()
